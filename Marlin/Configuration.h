...
// Created a breakout file for the Chiron
#include "Chiron.h"
...
//#define MACHINE_UUID "0f993a9f-a2ed-40b8-8f30-6a4f4a2bddab"
...
#elif DISABLED(BLTOUCH, FIXED_PROBE)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X GRID_SIZE
  #define GRID_MAX_POINTS_Y GRID_SIZE
  ...
  #define GRID_MAX_POINTS_X GRID_SIZE      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_SIZE
  ...
  #define MESH_INSET 1          // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X GRID_SIZE    // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_SIZE
...
#if EITHER(FIXED_PROBE, BLTOUCH)
  #define Z_SAFE_HOMING
#endif

#if ENABLED(Z_SAFE_HOMING)
  #if ENABLED(FIXED_PROBE)
    #define Z_SAFE_HOMING_X_POINT 17  // X point for Z homing
    #define Z_SAFE_HOMING_Y_POINT 17  // Y point for Z homing
  #else
