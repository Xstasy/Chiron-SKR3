 ...
 */
#if EITHER(FIX_MOUNTED_PROBE, BLTOUCH)
...
//
  ...
  #define TRAMMING_POINT_XY { {  35, 35 }, { 365, 30 }, { 365, 365 }, { 35, 365 } }
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -3.36
  ...
  #define LED_CONTROL_MENU
    ...
    #if ENABLED(NEOPIXEL2_SEPARATE)           // Enable a second NeoPixel Preset Color menu option
 ...
 */
  ...
  #define PROBE_PT_1_Y 375
  #define PROBE_PT_2_X 35
  #define PROBE_PT_2_Y 35
  #define PROBE_PT_3_X 375
